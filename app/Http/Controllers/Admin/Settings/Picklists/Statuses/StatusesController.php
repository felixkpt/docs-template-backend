    ...
    public function index()
    {
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item autotable-view" data-id="' . $status->id . '" href="/admin/settings/picklists/statuses/' . $status->id . '">View</a></li>
                <li><a class="dropdown-item autotable-edit" data-id="' . $status->id . '" href="/admin/settings/picklists/statuses/' . $status->id . '">Edit</a></li>
                <li><a class="dropdown-item autotable-status-update" data-id="' . $status->id . '" href="/admin/settings/picklists/statuses/' . $status->id . '/status-update">' . ($status->status == 1 ? 'Deactivate' : 'Activate') . '</a></li>
            </ul>
        </div>
        ';
            })->paginate();
